...
class GlobalPlugin(globalPluginHandler.GlobalPlugin):
    ...
    def __init__(self):
        ...
        self.current_interval_index = 1 # Default 15s
    ...
    @script(description="Toggle autoplay", gesture="kb:NVDA+Shift+V")
    ...
    @script(description="Previous track", gesture="kb:NVDA+Shift+,")
    def script_prevTrack(self, gesture):
        self.prev_track()

    @script(description="Next track", gesture="kb:NVDA+Shift+/")
    def script_nextTrack(self, gesture):
        self.next_track()

    @script(description="Play/Pause", gesture="kb:NVDA+Shift+.")
    ...
    @script(description="Toggle shuffle", gesture="kb:NVDA+Shift+S")
    def script_toggleShuffle(self, gesture):
        self.shuffle = not self.shuffle
        ui.message(f"Shuffle {'on' if self.shuffle else 'off'}")

    @script(description="Resume playback", gesture="kb:NVDA+Shift+R")
    ...
    @script(description="Rewind", gesture="kb:NVDA+Shift+;")
    ...
    @script(description="Fast forward", gesture="kb:NVDA+Shift+'")
    ...
    @script(description="Cycle interval", gesture="kb:NVDA+Shift+J")
    ...
    @script(description="Volume Up", gesture="kb:Alt+NVDA+'")
    ...
    @script(description="Volume Down", gesture="kb:Alt+NVDA+;")
